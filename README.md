...
In Bios go to Advanced Mode
    ...
    In OC -> Advanced CPU configuration -> SVM Mode, set this to Enabled
        This will allow passthrough of hardware to virtualize guest operating systems
    In Settings -> Advanced -> Windows OS Configuration -> BIOS UEFI/CSM Mode, set this to UEFI
    ...
    In Settings -> Advanced -> Integrated Peripherals -> VGA Card Detection, set this to Ignore
